...
Acc_Children(Acc) {
    ...
    if Acc_Error()
       Return ; throw Exception(ErrorLevel,-1)
}
    ...
    if ComObjType(AccObj, "Name") != "IAccessible"
        ...
        Loop Parse, ChildPath, ., %A_Space%
            try {
                ...
                if Acc_Error()
                   Return ; throw Exception("Cannot access ChildPath Item", -1, "Item #" A_Index " -> " A_LoopField)
                return
            }
        Acc_Error(AccError)
        ...
        try {
            ...
            if Acc_Error()
               Return ; throw Exception("Cmd Not Implemented", -1, Cmd)
            return
        }
